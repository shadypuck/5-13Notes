...
\usetikzlibrary{decorations.pathmorphing,decorations.pathreplacing,calc,bending,fpu,angles,positioning}
\tikzset{
...
\newcommand{\fO}{\tikz[inner sep=0pt]{
    \node (O) {O};
    \fill (O) circle (3pt and 3.5pt);
}}

\newcommand{\Keq}{K_\textup{eq}}
\newcommand{\Ka}{K_\textup{a}}
\newcommand{\pKa}{\textup{p}\Ka}
